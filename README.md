...
If planning to commit any code to community repositories on GitHub, you may also want to check [this guide to setting up GitHub access](docs/github_setup.md)
